...
Feature: Keep recording state operable and understandable throughout Mimir
  ...
  @MTG-200 @red @renderer @accessibility
  ...
  @MTG-201 @red @renderer @accessibility
  ...
  @MTG-202 @red @renderer @accessibility
  ...
  @MTG-203 @red @desktop @accessibility
  ...
  @MTG-204 @red @desktop @accessibility
  ...
  @MTG-205 @red @desktop @accessibility
