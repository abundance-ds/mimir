...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            business_graph::runtime::graph_source,
            business_graph::runtime::graph_source_save,
            business_graph::runtime::graph_source_serialize,
            business_graph::runtime::graph_query,
            business_graph::runtime::graph_search,
            business_graph::runtime::graph_lookup,
            business_graph::runtime::graph_link_targets,
            business_graph::runtime::graph_references,
            ...
            git::git_file_history_available,
            ...
            managed_git::team_resource_list,
