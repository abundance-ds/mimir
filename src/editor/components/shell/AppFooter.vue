<template>
  <PaneBand as="div" kind="footer" data-editor-footer class="app-footer grid grid-cols-[minmax(0,1fr)_auto] items-center px-[28px] tracking-[0.4px] overflow-visible">
    <!-- Left: stats -->
